...
dotenv.config();
const { otp: { OTP_MESSAGE, OTP_EXPIRATION_PREFIX, OTP_EXPIRATION_SUFFIX }, messages: { IGNORE_EMAIL_MESSAGE }, verification: { EMAIL_VERIFICATION_HEADING, VERIFY_EMAIL_SUBJECT, VERIFY_EMAIL_BUTTON_TEXT, VERIFICATION_LINK_BASE, EMAIL_SENT_SUCCESSFULLY_MESSAGE }, } = mailerContent;
