...
const { errors: { USER_NOT_FOUND = "User not found.", GENERIC_ERROR_MESSAGE = "An internal server error occurred." } = {}, messages: { USER_LOGOUT_SUCCESS = "User logged out successfully." } = {} } = userContent || {};
