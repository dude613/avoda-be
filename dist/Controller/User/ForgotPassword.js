...
const { errors: { EMAIL_NOT_FOUND_ERROR = "Email address not found.", // Provide defaults
EMAIL_REQUIRED_ERROR = "Email address is required.", INVALID_EMAIL_FORMAT_ERROR = "Invalid email format.", GENERIC_ERROR_MESSAGE = "An internal server error occurred.", GOOGLE_LOGIN_REQUIRED = "Password reset is not available for Google accounts. Please log in with Google.", PASSWORD_ALREADY_EXIST = "New password cannot be the same as the old password.", // Added missing constant
 } = {}, // Default empty object
success: { PASSWORD_UPDATED_SUCCESS = "Password updated successfully." } = {}, messages: { PASSWORD_REQUIRED_ERROR = "Password is required.", PASSWORD_COMPLEXITY_ERROR = "Password does not meet complexity requirements.", // Provide default
PASSWORD_RESET_EMAIL_SENT = "Password reset email sent successfully.", } = {}, validations: { EMAIL: EMAIL_REGEX = /^[^\s@]+@[^\s@]+\.[^\s@]+$/, // Provide default regex
...
const typedForgotTemplate = ForgotTemplate;
