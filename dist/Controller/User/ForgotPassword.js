...
dotenv.config();
const { errors: { EMAIL_NOT_FOUND_ERROR, EMAIL_REQUIRED_ERROR, INVALID_EMAIL_FORMAT_ERROR, GENERIC_ERROR_MESSAGE, GOOGLE_LOGIN_REQUIRED, }, success: { PASSWORD_UPDATED_SUCCESS }, messages: { PASSWORD_REQUIRED_ERROR, PASSWORD_COMPLEXITY_ERROR, PASSWORD_RESET_EMAIL_SENT, }, validations: { EMAIL: EMAIL_REGEX, PASSWORD_REGEX }, } = userContent;
