...
const { errors: { EMAIL_NOT_FOUND_ERROR, EMAIL_REQUIRED_ERROR, INVALID_EMAIL_FORMAT_ERROR, PASSWORD_REQUIRED_INCORRECT, GENERIC_ERROR_MESSAGE }, success: { USER_LOGIN_SUCCESS }, messages: { PASSWORD_REQUIRED_ERROR, PASSWORD_COMPLEXITY_ERROR }, validations: { EMAIL: EMAIL_REGEX, PASSWORD_REGEX } } = userContent;
