...
const { errors: { EMAIL_NOT_FOUND_ERROR, EMAIL_REQUIRED_ERROR, INVALID_EMAIL_FORMAT_ERROR, USER_EMAIL_ALREADY_VERIFIED, USER_INVALID_OTP, GENERIC_ERROR_MESSAGE, TOO_MANY_REQUESTS_ERROR, OTP_NOT_SENT, }, success: { USER_EMAIL_VERIFIED, USER_REGISTER_SUCCESS, USER_SEND_OTP }, messages: { USER_OTP_EXPIRE }, validations: { EMAIL: EMAIL_REGEX }, } = userContent;
