...
exports.mailerContent = {
    ...
    verification: {
        ...
        VERIFICATION_LINK_BASE: "".concat(FRONTEND_URL, "/register/verifyCode"),
    },
    reset: {
        ...
        RESET_LINK_BASE: "".concat(FRONTEND_URL, "/new-password"),
    },
    invitation: {
        ...
        INVITATION_EMAIL_FOOTER_LINK: "".concat(FRONTEND_URL, "/contact"),
    }
};
